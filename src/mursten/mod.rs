...
// 
//  pub fn add_renderer<R: Renderer<B, D>>(mut self, renderer: R) -> Self {
...
//     D: Data,
// {
//     pub fn add<R: Renderer<B, D>>(mut self, renderer: R) {
//         self.renderers.push(Box::new(renderer));
//     }
//     pub fn render(&mut self, backend: &mut B, data: &D) {
//         for r in self.renderers.iter_mut() {
//             r.render(&mut self.backend, data);
//         }
//     }
// }
// 
