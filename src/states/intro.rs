        ...
        match self {
            ...
            &IntroState::TwinsRay(ref d) => {
                if let Some(id) = d.ray {
                    game.send_message(MessageDestination::Entity(id), Message::Kill);
                };
            ...
            &IntroState::Twins(ref d) => {
                if let Some(id) = d.twin1 {
                    game.send_message(MessageDestination::Entity(id), Message::Move(Direction::Left, 100.0));
                }
                if let Some(id) = d.twin2 {
                    game.send_message(MessageDestination::Entity(id), Message::Move(Direction::Right, 100.0));
                }
            ...
            &IntroState::TwinsMoving(ref d) => {
                if let Some(id) = d.mother {
                    game.send_message(MessageDestination::Entity(id), Message::Move(Direction::Up, 0.05 * INTRO_SPEED));
                }
            ...
            &IntroState::Set(ref d) => {
                ...
                if let Some(id) = d.twin1 { game.send_message(MessageDestination::Entity(id), Message::Kill) }
                if let Some(id) = d.twin2 { game.send_message(MessageDestination::Entity(id), Message::Kill) }
                if let Some(id) = d.stars { game.send_message(MessageDestination::Entity(id), Message::Move(Direction::Down, 2.0)) }
